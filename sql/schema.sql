...
insert into profil (id, nama_dusun, tagline, sejarah, hero_image_url, alamat, peta_query, pusat_lat, pusat_lng)
values (
  1,
  'Dusun Macanan',
  ...
  'https://placehold.co/1600x900/6b8f47/ffffff?text=Foto+Dusun+Macanan',
  '[Contoh: Dusun Macanan, Desa ___, Kecamatan ___, Kabupaten Magelang, Jawa Tengah]',
  'Dusun Macanan, Bligo, Magelang, Jawa Tengah',
  -7.4034,
  110.1553
);
...
insert into perangkat (nama, jabatan, foto_url, urutan) values
  ('[Nama Kepala Dusun]', 'Kepala Dusun', 'https://placehold.co/400x400/6b8f47/ffffff?text=Foto', 1),
  ('[Nama Ketua RW]', 'Ketua RW 01', 'https://placehold.co/400x400/6b8f47/ffffff?text=Foto', 2),
  ('[Nama Ketua RT]', 'Ketua RT 01', 'https://placehold.co/400x400/6b8f47/ffffff?text=Foto', 3);
...
insert into umkm (nama_usaha, deskripsi, kontak, foto_url) values
  ('[Contoh: Keripik Singkong Bu ___]', '[Deskripsi singkat produk UMKM, ganti setelah survei]', '[No. HP/WA]', 'https://placehold.co/600x400/6b8f47/ffffff?text=Foto+UMKM'),
  ('[Contoh UMKM lain]', '[Deskripsi singkat]', '[No. HP/WA]', 'https://placehold.co/600x400/6b8f47/ffffff?text=Foto+UMKM');
...
insert into galeri (judul, foto_url, kategori) values
  ('[Contoh: Balai Dusun]', 'https://placehold.co/800x600/6b8f47/ffffff?text=Foto+Fasilitas', 'Fasilitas'),
  ('[Contoh: Kerja Bakti Warga]', 'https://placehold.co/800x600/6b8f47/ffffff?text=Foto+Kegiatan', 'Kegiatan');
...
insert into aktivitas (slug, judul, tanggal, kategori, ringkasan, isi, foto_urls, status) values
  (
    ...
    'https://placehold.co/800x600/6b8f47/ffffff?text=Foto+Aktivitas',
    'aktif'
  );
...
insert into lokasi_peta (nama, kategori, lat, lng, deskripsi, bobot) values
  ('[Contoh] Posko KKN', 'Posko KKN', -7.4034, 110.1553, 'Titik contoh — ganti dengan koordinat asli posko KKN.', 3),
  ('[Contoh] Balai Dusun Macanan', 'Fasilitas Umum', -7.4042, 110.1561, 'Titik contoh — ganti dengan koordinat asli balai dusun.', 5),
  ('[Contoh] SD Setempat', 'Pendidikan', -7.4028, 110.1548, 'Titik contoh — ganti dengan koordinat asli sekolah.', 4),
  ('[Contoh] Puskesmas Pembantu', 'Kesehatan', -7.4020, 110.1565, 'Titik contoh — ganti dengan koordinat asli fasilitas kesehatan.', 2),
  ('[Contoh] UMKM Keripik', 'Ekonomi/UMKM', -7.4045, 110.1540, 'Titik contoh — ganti dengan koordinat asli UMKM.', 2);
...
create table batas_wilayah (
  ...
  warna text default '#56693f',
  created_at timestamptz default now()
);

insert into batas_wilayah (nama, geojson, warna) values (
  '[Contoh] Batas Dusun Macanan — GANTI dengan data asli',
  '{"type":"Polygon","coordinates":[[[110.1530,-7.4010],[110.1580,-7.4010],[110.1580,-7.4060],[110.1530,-7.4060],[110.1530,-7.4010]]]}',
  '#56693f'
);
